...
// O(log(1)) space complexity
// Time to complete: NA min
// Patterns: Binary Search
// Notes w.r.t. solution: w/ Iteration
/**
...
var getIndex = function (reader) {
  ...
  while (length > 1) {
    ...
    const result = reader.compareSub(left, mid, mid + 1, left + 2 * length - 1); // Always assume even length of combined subsets
...
// Time to complete: 31:09 min
// Patterns: Binary Search
// Notes w.r.t. solution: w/ Recursion
/**
 * // This is the ArrayReader's API interface.
 * // You should not implement it, or speculate about its implementation
 * function ArrayReader() {
